...
from .models import Club, ClubResponsible, Contact, Committee, Position, Role, Team, TeamPlayer, User
...
class CommitteeWithUserSerializer(serializers.ModelSerializer):
    user = UserSerializer()
    class Meta: 
        model = Committee
        fields = '__all__'
